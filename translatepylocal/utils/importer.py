...
from translatepylocal.language import LANGUAGE_CLEANUP_REGEX

from translatepylocal.translators import (BingTranslate, DeeplTranslate,
...
from translatepylocal.utils._importer_data import VECTORS
...
def get_translator(translator: str, threshold: float = 90, forceload: bool = False) -> BaseTranslator:
    ...
    Returns
    -------
    translator : translatepylocal.translators.BaseTranslator
