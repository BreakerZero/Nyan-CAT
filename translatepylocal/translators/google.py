...
from translatepylocal.exceptions import ServiceURLError, UnsupportedMethod
    ...
    def _transliterate(self, text: str, destination_language: str, source_language: str) -> str:
        ...
        try:
            ...
            if origin_pronunciation is None:
                raise ValueError("translatepylocal internal exception: Origin Pronounciation is None")
        except Exception:
