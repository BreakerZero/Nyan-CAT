...
from translatepylocal.exceptions import ParameterTypeError, ParameterValueError, TranslatepyException, UnsupportedMethod, UnsupportedLanguage
from translatepylocal.language import Language
from translatepylocal.models import (DictionaryResult, ExampleResult,
                                LanguageResult, SpellcheckResult,
                                TextToSpechResult, TranslationResult,
                                TransliterationResult)
from translatepylocal.utils.annotations import List
...
class BaseTranslator(ABC):
    ...
    def translate(self, text: str, destination_language: str, source_language: str = "auto", formality: str = None, glossary: FormatedGlossary = "", prev_paragraph: str = "", next_paragraph: str = "") -> TranslationResult:
        """
        ...
        if _cache_key in self._translations_cache:
            ...
            source_language, translation = self._translate(text, dest_code, source_code, formality, glossary, prev_paragraph, next_paragraph)
    ...
    def _translate(self, text: str, destination_language: str, source_language: str, formality: str = None, glossary: FormatedGlossary = "", prev_paragraph: str = "", next_paragraph: str = "") -> str:
        """
