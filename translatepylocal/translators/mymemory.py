...
from translatepylocal.utils.annotations import Tuple
...
class MyMemoryTranslate(BaseTranslator):
    """
    translatepylocal's implementation of MyMemory
    """
    ...
    def _language_normalize(self, language: Language) -> str:
        ...
        It receives a "translatepylocal.language.Language" object and returns the correct language code
    ...
    def _language_denormalize(self, language_code) -> str:
        ...
        It receives a string with the translator language code and returns a "translatepylocal.language.Language" object
