"""
This implementation was made specifically for translatepylocal by 'Zhymabek Roman'.
"""
...
from translatepylocal.exceptions import UnsupportedMethod
from translatepylocal.language import Language
from translatepylocal.translators.base import BaseTranslateException, BaseTranslator
from translatepylocal.utils.request import Request
from translatepylocal.utils.annotations import Callable, Dict
from translatepylocal.translators.bing import BingSessionManager, BingExampleResult
...
class MicrosoftSessionManager():
    def __init__(self, request: Request):
        ...
        self._auth_session_file = JSONFile(os.path.join(HOME_DIR, ".microsoft_translatepylocal"), blocking=False)
