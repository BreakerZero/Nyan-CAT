"""
This implementation was made specifically for translatepylocal from 'Zhymabek Roman', based on 'Anime no Sekai' version.
"""
...
class BingSessionManager():
    def __init__(self, request: Request, captcha_callback: Callable[[str], str] = None):
        ...
        self._auth_session_file = JSONFile(os.path.join(HOME_DIR, ".bing_translatepylocal"), blocking=False)
