from deeplprovider.data.data import ALPHA3_TO_ALPHA2, LANGUAGES_CODE
from deeplprovider.data.data import LANGUAGES_NAME_TO_CODE_EN
from deeplprovider.data.data import LANGUAGES_NAME_TO_CODE_INTERNATIONAL
from deeplprovider.data.data import LANGUAGES_CODE_TO_NAME_EN
from deeplprovider.data.data import LANGUAGES_TO_INTERNATIONAL
from deeplprovider.data.data import ALPHA2_TO_ALPHA3
from deeplprovider.utils.similarity import language_search
from deeplprovider.models.exceptions import UnknownLanguage
