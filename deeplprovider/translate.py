...
from deeplprovider.translators.google import GoogleTranslate
from deeplprovider.translators.bing import BingTranslate
from deeplprovider.translators.yandex import YandexTranslate
from deeplprovider.translators.reverso import ReversoTranslate
from deeplprovider.translators.deepl import DeepL
from deeplprovider.translators.unselected import Unselected

from deeplprovider.utils.annotations import List, Dict
...
class Translator():
    ...
    def translate(self, text, destination_language, source_language=None, dictionary="test,test", formality=None) -> Union[TranslationResult, None]:
        """
        ...
        for service in services:
            if not isinstance(service, Unselected):
                lang, response = service.translate(text, destination_language, source_language, dictionary, formality)
